...
const Orders = () => {
    ...
    function changeWaiterForOrder(){
        ...
        var url = process.env.baseUrl+"/waiter/update/" + changeWaiter.id
        axios.put(url, {
    ...
    function changeSingleOrder(){
        ...
        var url = process.env.baseUrl+"/order/update/" + changeOrder.id
    ...
    function addSingleOrder(){
        ...
        var url = process.env.baseUrl+"/order/create"
        axios.post(url, {
    ...
    function getAllOrders(){
        var url = process.env.baseUrl+"/orders"
        axios.get(url, {
            responseType: 'json'
        }).then(response => {
            if(response.status === 200){
    ...
    function deleteSingleOrder(id){
        var url = process.env.baseUrl+"/order/delete/" + id
        axios.delete(url, {
